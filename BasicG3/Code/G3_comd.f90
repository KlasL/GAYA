...
DATA cvar(139:162)/'F1 F2 LT AS TS SI F3 PR '/	! FIX + Period
...
ELSE
  ...
  i1=nk-2
END IF
CALL  g3jfr(162,cvar,2,ch(i1:i1+1),ioka1(nvk,k))
...
ELSE
  ...
  i1=nk-2
END IF
CALL  g3jfr(162,cvar,2,ch(i1:i1+1),ioknf1(nvk,k))
...
ELSE
  ...
  i1=nk-2
END IF
CALL  g3jfr(162,cvar,2,ch(i1:i1+1),iauta1(nvk,k))
...
ELSE
  ...
  i1=nk-2
END IF
CALL  g3jfr(162,cvar,2,ch(i1:i1+1),noka1(nvk,k))
