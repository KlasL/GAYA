...
!-- EGNA DEKLARATIONER
       ...
       CHARACTER :: CstandId*13,Cout*2000,VerOut*4
        ...
        write(nr,'(a))')Cout(1:k-1)
            ...
            ! factor info (excl. cost)
                ...
                if(FirstWrite)write(70,'(99a)')'Factor,Plot,Prog,Periods,PlotOutput'
                 ...
                 write(70,'(2x,a,",",a,",",a,",",i4,",",f6.1)')	&
                 'BerTim',CstandId, jNr, iiper,restim(Birch,iiper)
  			            if( restim(Oak,iiper) > 1. )	&
                 write(70,'(2x,a,",",a,",",a,",",i4,",",f6.1)')	&
                 'OakTim',CstandId, jNr, iiper,restim(Oak,iiper)
  			            if( restim(Poppel,iiper) > 1. )	&
                 write(70,'(2x,a,",",a,",",a,",",i4,",",f6.1)')	&
                 'PopTim',CstandId, jNr, iiper,restim(Poppel,iiper)
                 ...
                 'SprPuw',CstandId, jNr, iiper,resmav(Spruce,iiper)
  			            if( Decids > 1. )	&
                 write(70,'(2x,a,",",a,",",a,",",i4,",",f6.1)')	&
                 'Decids',CstandId, jNr, iiper,Decids
			            if( ResStm(iiper) > 1. )	&
                 write(70,'(2x,a,",",a,",",a,",",i4,",",f6.1)')	&
