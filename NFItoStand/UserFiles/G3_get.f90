    ...
    real ::         NFI_Area(maxNFI)
    integer ::      NFI_County(maxNFI)
    integer ::      NFI_Municipality(maxNFI)
    real ::         NFI_Lat(maxNFI)
    real ::         NFI_ASL(maxNFI)
    ...
    if(Start)then
        ...
        NoNFI = 1
 		do while(Start)
            ...
            NFI_Area(NoNFI), &	! Areafactor (ha)
            NFI_County(NoNFI), &	! County code
            NFI_Municipality(NoNFI), &	! Municipality code
...
!           16= ljung  17= odon/skvattram  18= rosling/tranb„r
            ...
            NFI_mToRoad(NoNFI), &		! distance to road
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    read(cin2(21),*)    St_Tsum
    read(cin2(22),*)    St_DeadWood
    read(cin2(23),*)    St_SI
    read(cin2(24),*)    St_mToRoad
    read(cin2(25),*)    St_TerrTrpStatus
