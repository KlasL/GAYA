...
mt=t*1.197*1.276/(60.*V*0.8) ! 1.197 = correction for break time; 1.276 = correction for terrain; 0.8 = conversion from m3sk to m3f

End Function

Real Function ForwTimeFi(Form,Slog,Pwood,Dist,r) result(mt)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
x1=Dist;x2=Dist				! Driving empty and loaded, respectively, distance (m)
