...
DATA cvar(61: 96)/'A1 A2 A3 A4 A5 A6 A7 A8 A9 AA AB AC '/		! BEST
DATA cvar(67:132)/'I1 I2 I3 LC FT PE DH MO ZO I4 I5 I6 '/ 	! IFIX
...
21      k=k+1
i=0
CALL  G3GET_NewForest(nrfil(2),ierr,iend)
IF(iend == 1)GO TO 1
IF(ierr == 1)GO TO 260
nfnew=nfnew+1
